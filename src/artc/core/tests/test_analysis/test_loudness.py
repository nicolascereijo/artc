...
def test_compare_two_loudness(setup):
    ...
    assert (
        analysis.compare_two_loudness(
            audio_signal2, audio_signal2, sample_rate1, sample_rate1
        )
        == 1
    )
    assert (
        analysis.compare_two_loudness(
            audio_signal3, audio_signal3, sample_rate1, sample_rate1
        )
        == 1
    )
    ...
    assert (
        round(
            analysis.compare_two_loudness(
                audio_signal1, audio_signal2, sample_rate1, sample_rate1
            ),
            5,
        )
        == 0.7556
    ...
    assert (
        round(
            analysis.compare_two_loudness(
                audio_signal2, audio_signal1, sample_rate1, sample_rate1
            ),
            5,
        )
        == 0.7556
    ...
    assert (
        round(
            analysis.compare_two_loudness(
                audio_signal1, audio_signal3, sample_rate1, sample_rate1
            ),
            5,
        )
        == 0.70426
    ...
    assert (
        round(
            analysis.compare_two_loudness(
                audio_signal3, audio_signal1, sample_rate1, sample_rate1
            ),
            5,
        )
        == 0.70426
    ...
    assert (
        round(
            analysis.compare_two_loudness(
                audio_signal2, audio_signal3, sample_rate1, sample_rate1
            ),
            5,
        )
        == 0.60365
    ...
    assert (
        round(
            analysis.compare_two_loudness(
                audio_signal3, audio_signal2, sample_rate1, sample_rate1
            ),
            5,
        )
        == 0.60365
...
def test_compare_multiple_loudness(setup):
    ...
    assert (
        analysis.compare_multiple_loudness(
            [audio_signal1, audio_signal1], [sample_rate1, sample_rate1]
        )
        == 1
    )
