...
def test_compare_multiple_zcr(setup):
    ...
    assert (
        analysis.compare_multiple_zcr([audio_signal1, audio_signal1, audio_signal1])
        == 1
    )
    assert (
        analysis.compare_multiple_zcr([audio_signal2, audio_signal2, audio_signal2])
        == 1
    )
    assert (
        analysis.compare_multiple_zcr([audio_signal3, audio_signal3, audio_signal3])
        == 1
    )
