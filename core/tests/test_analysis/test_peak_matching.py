...
def test_compare_two_peak_matching(setup):
    ...
    assert analysis.compare_two_peak_matching(
    ...
    assert round(analysis.compare_two_peak_matching(
...
def test_compare_multiple_peak_matching(setup):
    ...
    assert analysis.compare_multiple_peak_matching(
        [audio_signal1, audio_signal1],
        [sample_rate1, sample_rate1],
        n_fft=n_fft
    ) == 1
    ...
    assert round(analysis.compare_multiple_peak_matching(
        [audio_signal1, audio_signal2],
        [sample_rate1, sample_rate2],
        n_fft=n_fft), 5
    ) == 0.71765
