...
def test_compare_two_tempo(setup):
    ...
    assert analysis.compare_two_tempo(
    ...
    assert round(analysis.compare_two_tempo(
...
def test_compare_multiple_tempo(setup):
    ...
    assert analysis.compare_multiple_tempo(
        [audio_signal1, audio_signal1],
        [sample_rate1, sample_rate1],
        hop_length=hop_length
    ) == 1
    ...
    assert round(analysis.compare_multiple_tempo(
        [audio_signal1, audio_signal2],
        [sample_rate1, sample_rate2],
        hop_length=hop_length), 5
    ) == 0.96
