...
def test_compare_two_pitch(setup):
    ...
    assert analysis.compare_two_pitch(
    ...
    assert round(analysis.compare_two_pitch(
...
def test_compare_multiple_pitch(setup):
    ...
    assert analysis.compare_multiple_pitch(
        [audio_signal1, audio_signal1],
        [sample_rate1, sample_rate1],
        n_fft=n_fft
    ) == 1
    ...
    assert round(analysis.compare_multiple_pitch(
        [audio_signal1, audio_signal2],
        [sample_rate1, sample_rate2],
        n_fft=n_fft), 5
    ) == 0.46676
